-- Clean SuperInu River Leaderboard Setup
...
CREATE POLICY "Prevent updates" ON public.leaderboard FOR UPDATE USING (false);
CREATE POLICY "Prevent deletes" ON public.leaderboard FOR DELETE USING (false);
