            ...
            <div>
              ...
              <div className="game-section">
                ...
                <ul>
                  ...
                  <li><strong>Controls:</strong> Tap to move SuperInu around the river</li>
                  <li><strong>Scoring:</strong> Each token collected adds to your score</li>
                  <li><strong>Game Over:</strong> Game ends after missing 10 tokens</li>
                  <li><strong>Goal:</strong> Collect SuperFluid tokens and get the highest score</li>
                </ul>
              </div>
              ...
              <div className="game-section">
                ...
                <div className="trending-preview">
                  <div className="trending-item">
                    <div className="trending-rank">#1</div>
                    <div className="trending-info">
                      <div className="trending-name">SuperInu River</div>
